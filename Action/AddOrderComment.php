...
class AddOrderComment implements ActionInterface
{
    ...
    public function execute(RuleInterface $rule): void
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            try {
                $this->addOrderComment($orderId, $rule);
                $actionLogData = [
                ...
                $errorMessage = 'There was an error while adding order comment by order automation rule. '
     ...
     * @return void
     */
    private function addOrderComment(int $orderId, RuleInterface $rule): void
    {
