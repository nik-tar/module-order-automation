 ...
 */
class RuleBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Rule';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'automation_rule/rule/edit';
    private const DELETE_URL_PATH = 'automation_rule/rule/delete';
                ...
                if (isset($item[OrderAutomationRuleInterface::RULE_ID])) {
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => $this->getActionData(
                            ...
                            (string)__('Are you sure you want to delete a %1 rule?', $entityName)
                        )
                    ];
                }
            }
